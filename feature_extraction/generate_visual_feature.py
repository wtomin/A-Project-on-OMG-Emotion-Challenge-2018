...
def main():
    ...
    for folder in folders:
        ...
        des = 'Visual_Feature/'+folder+'-'+layer+'-'+model+'.pkl'
    ...
    for model in dic.keys():
        for layer in dic[model]:
            train_f = 'Visual_Feature/'+'Train'+'-'+layer+'-'+model+'.pkl'
            valid_f = 'Visual_Feature/'+'Validation'+'-'+layer+'-'+model+'.pkl'
            with open(train_f,'rb') as fin:
                train_dict = pickle.load(fin)
            with open(valid_f, 'rb') as fin:
                valid_dict = pickle.load(fin)
            data = {}
            data['Train'] = train_dict
            data['Validation'] = valid_dict
            des = 'Visual_Feature/'+layer+'-'+model+'.pkl'
